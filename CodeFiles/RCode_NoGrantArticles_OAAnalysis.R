...
PublishersOANoGrants <- tabyl(Articles_InstCorresponding_NoGrants, host_organization_name, oa_status)
...
PublishersOANoGrants <- PublishersOANoGrants %>% 
  add_column(oatype = 0)
...
Percent_PublishersOANoGrants <- Percent_PublishersOANoGrants %>% 
